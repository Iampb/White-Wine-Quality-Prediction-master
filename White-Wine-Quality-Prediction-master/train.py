...
parser.add_argument('--use_cuda', type=int, default=True) # 是否使用GPU训练
...
def train():
    ...
    if not os.path.exists("./output2"): # 创建输出文件夹
        os.mkdir("./output2")
    else:
    ...
    for epoch in range(args.epochs): 
        ...
        if (epoch+1) % 100 == 0:
            torch.save(net.state_dict(), f'./output2/epoch_{epoch+1}.pt')

    torch.save(net.state_dict(), f'./output2//Model.pt')
    print("Model saved at: ./output2/Model.pt")
